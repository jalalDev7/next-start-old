...
const EditClient = ({ client }: { client: clientData }) => {
  ...
  const form = useForm<z.infer<typeof clientSchema>>({
    ...
    defaultValues: {
      ...
      cid: client.cid || undefined,
      permis: client.permis || undefined,
  ...
  const onSubmit = (values: z.infer<typeof clientSchema>) => {
    startTransition(() => {
      updateClient(values, client.id).then((res) => {
        console.log(res);
        if (res.error) {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <BackLink
        text="Retourner vers la page des clients"
